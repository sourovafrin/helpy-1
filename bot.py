...
whitelist = ['anritco','samest','karinxxl','stackin','gaeljosser', 'thebugiq','zakaria','tedtv','dangyver','ladyfont','azizbd','muh543','chilix','sardart','xawi','rehan12']
cmnt = ['thebugiq']
print("Running")
